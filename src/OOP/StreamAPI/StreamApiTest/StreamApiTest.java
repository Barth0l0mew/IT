package OOP.StreamAPI.StreamApiTest;
...
public class StreamApiTest {
    ...
    public void test1() {
       ...
       // Assertions.assertEquals(new String[]{"0","1","2","4"}, set.toArray());
    }
...
//    }
    ...
    List<String> str = numbers.stream().collect(Collectors.toList());
    String[] str2 = str.toArray(new String[0]);
    //String[] str2 = (String[]) str.toArray();
        Arrays.sort(str2);
        System.out.println(Arrays.toString(str2));
    //        Assertions.assertArrayEquals(new String[]{"0","1","1","2","3","4","5","6","9","9"}, numbersList.toArray());
        Assertions.assertArrayEquals( str2, numbersList.toArray());
